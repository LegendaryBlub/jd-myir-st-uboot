#ifndef __media_home_beste_01_Pro_ld25x_bsp_hu_MYD_LD25X_Uboot_L2022_10_V1_0_0_Bootloader_myir_st_optee____build_myb_stm32mp257x_2GB_include_generated_conf_h_
#define __media_home_beste_01_Pro_ld25x_bsp_hu_MYD_LD25X_Uboot_L2022_10_V1_0_0_Bootloader_myir_st_optee____build_myb_stm32mp257x_2GB_include_generated_conf_h_
...
#define CFG_DRIVERS_REMOTEPROC 1
...
#define CFG_EMBED_DTB_SOURCE_FILE myb-stm32mp257x-2GB.dts
...
#define CFG_EXT_DTS /media/home/beste/01_Pro/ld25x/bsp_hu/MYD-LD25X-Uboot-L2022.10-V1.0.0/Bootloader/myir-st-external-dt/optee//optee
...
#define CFG_IN_TREE_EARLY_TAS remoteproc/80a4c275-0a47-4905-8285-1486a9771a08 stm32mp_nvmem/1a8342cc-81a5-4512-99fe-9e2b3e37d626
...
#define CFG_SCMI_SCPFW 1
#define CFG_SCMI_SCPFW_PRODUCT optee-stm32mp2
#define CFG_SCMI_SERVER_REGULATOR_CONSUMER 1
/* CFG_SCPFW_CLOCK_TREE_MGMT is not set */
/* CFG_SCPFW_FAST_CHANNEL is not set */
/* CFG_SCPFW_FAST_CHANNELS is not set */
#define CFG_SCPFW_LOG_LEVEL 1
#define CFG_SCPFW_MOD_CLOCK 1
#define CFG_SCPFW_MOD_DVFS 1
/* CFG_SCPFW_MOD_MOCK_CLOCK is not set */
/* CFG_SCPFW_MOD_MOCK_PPU is not set */
/* CFG_SCPFW_MOD_MOCK_PSU is not set */
#define CFG_SCPFW_MOD_MSG_SMT 1
#define CFG_SCPFW_MOD_OPTEE_CLOCK 1
#define CFG_SCPFW_MOD_OPTEE_CONSOLE 1
#define CFG_SCPFW_MOD_OPTEE_MBX 1
#define CFG_SCPFW_MOD_OPTEE_RESET 1
/* CFG_SCPFW_MOD_OPTEE_SMT is not set */
#define CFG_SCPFW_MOD_POWER_DOMAIN 1
#define CFG_SCPFW_MOD_PSU 1
#define CFG_SCPFW_MOD_PSU_OPTEE_REGULATOR 1
/* CFG_SCPFW_MOD_REG_SENSOR is not set */
#define CFG_SCPFW_MOD_RESET_DOMAIN 1
#define CFG_SCPFW_MOD_SCMI 1
/* CFG_SCPFW_MOD_SCMI_APCORE is not set */
#define CFG_SCPFW_MOD_SCMI_CLOCK 1
#define CFG_SCPFW_MOD_SCMI_PERF 1
#define CFG_SCPFW_MOD_SCMI_POWER_DOMAIN 1
#define CFG_SCPFW_MOD_SCMI_RESET_DOMAIN 1
/* CFG_SCPFW_MOD_SCMI_SENSOR is not set */
#define CFG_SCPFW_MOD_SCMI_VOLTAGE_DOMAIN 1
/* CFG_SCPFW_MOD_SENSOR is not set */
#define CFG_SCPFW_MOD_STM32_PD 1
#define CFG_SCPFW_MOD_STM32_REGU_CONSUMER 1
/* CFG_SCPFW_MOD_SYSTEM_PLL is not set */
#define CFG_SCPFW_MOD_VOLTAGE_DOMAIN 1
...
#define CFG_STM32MP_REMOTEPROC 1
#define CFG_STM32_BSEC3 1
...
#define CFG_STM32_HSE_MONITORING 1
...
#define _CFG_SCP_FIRMWARE_IN_TREE 1
