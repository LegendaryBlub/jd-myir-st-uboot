...
// options passed: -mstrict-align -mno-outline-atomics -mgeneral-regs-only -mlittle-endian -mabi=lp64 -g3 -Os -std=gnu11 -ffunction-sections -fdata-sections
	.text
.Ltext0:
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 2 "/media/home/beste/01_Pro/ld25x/bsp_hu/MYD-LD25X-Uboot-L2022.10-V1.0.0/GEN_FIP/myir-st-optee/../build/myb-stm32mp257x-2GB/include/generated/conf.h"
	.byte	0x3
	.uleb128 0
	.uleb128 0x2
	.byte	0x7
...
.Ldebug_macro2:
	...
	.4byte	.LASF407
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.conf.h.2.f74560da30cda9fcfa32a04fa74d8558,comdat
.Ldebug_macro3:
	.2byte	0x5
	.byte	0
	.byte	0x5
...
.LASF576:
	.string	"CFG_STM32MP_OPP_COUNT 3"
.LASF1993:
...
.LASF498:
	.string	"CFG_EXT_DTS /media/home/beste/01_Pro/ld25x/bsp_hu/MYD-LD25X-Uboot-L2022.10-V1.0.0/GEN_FIP/myir-st-external-dt/optee"
.LASF895:
...
.LASF496:
	.string	"CFG_EMBED_DTB_SOURCE_FILE myb-stm32mp257x-2GB.dts"
.LASF2003:
...
.LASF408:
	.string	"__media_home_beste_01_Pro_ld25x_bsp_hu_MYD_LD25X_Uboot_L2022_10_V1_0_0_GEN_FIP_myir_st_optee____build_myb_stm32mp257x_2GB_include_generated_conf_h_ "
.LASF1664:
...
.LASF2273:
	.string	"GNU C11 12.3.0 -mstrict-align -mno-outline-atomics -mgeneral-regs-only -mlittle-endian -mabi=lp64 -g3 -Os -std=gnu11 -ffunction-sections -fdata-sections"
.LASF1841:
