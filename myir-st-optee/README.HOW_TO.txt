...
In the optee-os source directory (sources/*/optee-os-stm32mp-3.19.0-stm32mp-r2-r0),
...
------------------------------------------------------
    ...
    Branch: 3.19.0-stm32mp
    Revision: 3.19.0-stm32mp-r2

    $ git clone https://github.com/STMicroelectronics/optee_os.git
    $ git checkout -b WORKING 3.19.0-stm32mp-r2
